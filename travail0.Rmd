...
#fonction qui calcul l'écart type d'un échantillon
help(sd)
sd(age) # calcul de l'écart type d'une échantillon d'age


```

Aide de la fonction matrix : 

Fonction qui permet de calculer l’écart-type d’un échantillon : 


Fonction qui permet de calculer le coefficient d'applatissement. 
